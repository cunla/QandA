...
import com.delirium.boiler.config.Constants;
import com.delirium.boiler.exceptions.BoilerAppLoadingException;
import com.delirium.boiler.tools.PortBinding;
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        app.run(args);
            ...
            System.err.println("!!! Failed to start boiler: " + e.getMessage());
            System.err.println("!!! Please send log files (boiler.log) to style.daniel@gmail.com");
        }
    }
    ...
    public void initApplication() throws IOException {
        ...
        if (!PortBinding.available(port)) {
            ...
            throw new BoilerAppLoadingException("Port unavailable, exiting");
        }
